...
def create_drug_development_agent(model_name: str = None, temperature: float = None, conversation_manager=None):
    ...
    항상 유머러스하고 친근하게 답변하되, 실제 의학적 조언은 전문의와 상담하라고 안내해주세요.
    해커톤 참가자들의 스트레스를 풀어주고 창의적 영감을 주는 것이 목표입니다!
    
    신약개발의 어려움을 이해하고, 연구자들을 격려하는 톤으로 대화하세요.
    """
